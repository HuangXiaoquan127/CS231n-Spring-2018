...
#       dists[i,:] = np.sqrt(np.sum((self.X_train-X[i,:])**2,axis = 1))
  ...
  def compute_distances_no_loops(self, X):
    ...
    X_squar = np.sum(X * X, axis = 1)
#     print(X_squar.shape)
#     print(X_squar)
    X_train_squar = np.sum(self.X_train * self.X_train, axis = 1)
#     print(X_train_squar.shape)
#     print(X_train_squar)
    
    dists = np.sqrt(((-2*MUL).T + X_squar).T + X_train_squar)
#     dists = np.sqrt((-2*MUL) + X_train_squar + X_squar)
